...
export class CrearLibroDto implements Partial<Libro> {
  ...
  @ApiProperty({
    ...
    description: 'El número de páginas del libro a crear',
    example: 100,
    minLength: 1,
    maxLength: 255,
  })
  ...
  @ApiProperty({
    title: 'Id de grado',
    description: 'El id de grado del libro a crear',
    example: 1,
    minLength: 1,
    maxLength: 4294967295,
  })
...
export class ActualizarLibroDto implements Partial<Libro> {
  @ApiPropertyOptional({
    title: 'Nombre del libro',
    description: 'El nombre del libro a actualizar',
    example: 'El libro de la mente',
    minLength: 3,
    maxLength: 100,
  })
  ...
  @ApiPropertyOptional({
    title: 'Número de páginas',
    description: 'El número de páginas del libro a actualizar',
    example: 100,
    minLength: 1,
    maxLength: 255,
  })
  ...
  @ApiPropertyOptional({
    ...
    example: 5,
    minLength: 0,
    maxLength: 4294967295, // 2^32 - 1 = 4.294.967.295
  })
  @IsOptional()
  @IsInt({ message: 'La cantidad de veces leído debe ser un número entero' })
  @Min(0, { message: 'La cantidad de veces leído debe ser mayor o igual a 0' })
  ...
  @ApiPropertyOptional({
    title: 'Id de grado',
    description: 'El id de grado del libro a actualizar',
    example: 1,
    minLength: 1,
    maxLength: 4294967295, // 2^32 - 1 = 4.294.967.295
  })
